...
export const begin: express.RequestHandler = async (req, res) => {
  console.log(
    'BEGIN 3RD PARTY OAUTH LOGIN HANDLER ==============================================',
    '\n'
  );
...
export const zoomAuth: express.RequestHandler = async (req, res, next) => {
  console.log(
    'ZOOM OAUTH REDIRECT HANDLER ==============================================',
    '\n'
  );
...
export const auth0Auth: express.RequestHandler = async (req, res, next) => {
  console.log(
    'AUTH0 REDIRECT HANDLER ==============================================',
    '\n'
  );
...
export const proxy: express.RequestHandler = async (req, res, next) => {
  console.log(
    'AUTH0 API PROXY ==============================================',
    '\n'
  );
