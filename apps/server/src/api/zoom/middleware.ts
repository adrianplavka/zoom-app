...
export const getUser: express.RequestHandler = async (req, res, next) => {
...
export const refreshToken: express.RequestHandler = async (req, res, next) => {
...
export const setZoomAuthHeader: express.RequestHandler = async (req, res, next) => {
  try {
    if (!req.session.user) {
      throw new Error(
